package com.yamed.sqli.echallenge.test;
...
public class Test {
	...
	public static void main(final String[] args) {
		...
		final List<Integer> ListOfDuplicateNumbers = new ArrayList<>();
		...
		final String message = " ymm yamani Mohammed med code";
		// Test compress
	 ...
	 * @return string message as a compressed message
	 */
	 ...
	 * @return count pair
	 */
	public static int countPair(final List<Integer> listNumbers, final int k) {
	 ...
	 */
	public static int countNonUniuque(final List<Integer> listNumbers) {
		int countNonUniuque = 0;
		Set<Integer> collectionsNumbers = new HashSet<>();
		final int sizeList = listNumbers.size();
